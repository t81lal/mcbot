package org.topdank.mc.bot.api.message;
...
public class MessageStyle implements Cloneable {
	...
	public MessageStyle clone() {
		return new MessageStyle().setParent(this.parent).setColor(this.color).setFormats(this.formats).setClickEvent(this.click != null ? this.click.clone() : null)
				.setHoverEvent(this.hover != null ? this.hover.clone() : null).setInsertion(this.insertion);
	}
	...
	public boolean equals(Object o) {
		...
		if (click != null ? !click.equals(style.click) : style.click != null)
			return false;
		if (color != style.color)
			return false;
		if (!formats.equals(style.formats))
			return false;
		if (hover != null ? !hover.equals(style.hover) : style.hover != null)
			return false;
		if (insertion != null ? !insertion.equals(style.insertion) : style.insertion != null)
			return false;
		if (!parent.equals(style.parent))
			return false;
